		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="xueshengxingbie" id="xueshengxingbie" lay-filter="xueshengxingbie">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in xueshengxingbie" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>

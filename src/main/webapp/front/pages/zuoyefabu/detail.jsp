				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('zuoyefabu','做作业')" @click="onAcrossTap('zuoye')" type="button" class="layui-btn">
								做作业
							</button>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`zuoyefabu`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.zuoyebianhao;
																				vue.title = vue.detail.zuoyebiaoti;
																				// 轮播图片
					vue.swiperList = vue.detail.zuoyetupian ? vue.detail.zuoyetupian.split(",") : [];
																																																																																															var swiperItemHtml = '';

				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>资源编号：</span>
							<span class="desc">
								{{detail.ziyuanbianhao}}
							</span>
						</div>
																								<div class="detail-item">
							<span>教学项目：</span>
							<span class="desc">
								{{detail.jiaoxuexiangmu}}
							</span>
						</div>
																								<div class="detail-item">
							<span>教学内容：</span>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('jiaoxuefankui','答疑')" @click="onAcrossTap('jiaoxuedayi')" type="button" class="layui-btn">
								答疑
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`jiaoxuefankui`);

				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('jiaoxueziyuan','反馈信息')" @click="onAcrossTap('jiaoxuefankui')" type="button" class="layui-btn">
								反馈信息
							</button>
		...
		<script>
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.ziyuanbianhao;
																				vue.title = vue.detail.jiaoxuexiangmu;
																														// 轮播图片
					vue.swiperList = vue.detail.jiaoxuetupian ? vue.detail.jiaoxuetupian.split(",") : [];

      ...
      <div class="login-form">
        ...
        <div class="agileits-top">
          <form class="layui-form">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="dayixinxi" name="dayixinxi" placeholder="请输入答疑信息" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="dayineirong" name="dayineirong" placeholder="请输入答疑内容" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>

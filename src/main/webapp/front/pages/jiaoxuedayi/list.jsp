  ...
  <div id="app">
    ...
    <fieldset class="search-container" style="text-align: center;margin: 50px 0;">
      <form class="layui-form" style="margin: 10px 0;">
        ...
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('jiaoxuedayi','新增')" @click="jump('../jiaoxuedayi/add.jsp')" type="button" class="layui-btn btn-theme">
    ...
    <div class="product">
      <div class="proBox" v-for="(item,index) in dataList" v-bind:key="index">
        ...
        <div class="proBoxtxt">
          <a :href="'../jiaoxuedayi/detail.jsp?id='+item.id">查看详情</a>
        </div>
      </div>
      <div class="clear"></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#dayixinxi').val()) {
          param['dayixinxi'] = jquery('#dayixinxi').val() ? '%' + jquery('#dayixinxi').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('jiaoxuedayi/list', 'get', param, function(res) {

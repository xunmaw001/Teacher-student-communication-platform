...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>教师性别</label>
										<select id="jiaoshixingbieSelect" name="jiaoshixingbie" class="form-control">
												<option value=""></option>
												<option class="jiaoshixingbieOption" value="男">
													男
												</option>
												<option class="jiaoshixingbieOption" value="女">
													女
												</option>
										</select>	
									</div>	
	...
	<script>
		...
		function dataBind(){
			...
			var jiaoshixingbieOptions = document.getElementsByClassName("jiaoshixingbieOption");
			for(var jiaoshixingbieCount = 0; jiaoshixingbieCount < jiaoshixingbieOptions.length;jiaoshixingbieCount++){
				if(jiaoshixingbieOptions[jiaoshixingbieCount].getAttribute('value') == ruleForm.jiaoshixingbie){
					jiaoshixingbieOptions[jiaoshixingbieCount].setAttribute('selected','selected');
				}
			}
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					var jiaoshixingbieOptions = document.getElementsByClassName("jiaoshixingbieOption");
						for(var jiaoshixingbieCount = 0; jiaoshixingbieCount < jiaoshixingbieOptions.length;jiaoshixingbieCount++){
							if(jiaoshixingbieOptions[jiaoshixingbieCount].getAttribute('value') == res.data.jiaoshixingbie){
								jiaoshixingbieOptions[jiaoshixingbieCount].setAttribute('selected','selected');
							}
						}
					}

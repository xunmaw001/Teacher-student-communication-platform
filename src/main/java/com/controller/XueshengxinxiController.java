...
public class XueshengxinxiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XueshengxinxiEntity user = xueshengxinxiService.selectOne(new EntityWrapper<XueshengxinxiEntity>().eq("xueshengzhanghao", username));
    ...
    public R register(@RequestBody XueshengxinxiEntity xueshengxinxi){
    	...
    	XueshengxinxiEntity user = xueshengxinxiService.selectOne(new EntityWrapper<XueshengxinxiEntity>().eq("xueshengzhanghao", xueshengxinxi.getXueshengzhanghao()));
		if(user!=null) {

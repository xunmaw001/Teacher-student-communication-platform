...
public class JiaoxueziyuanVO  implements Serializable {
	...
	public void setJiaoxuetupian(String jiaoxuetupian) {
		this.jiaoxuetupian = jiaoxuetupian;
	}
	
	/**
	 * 获取：教学图片
	 */
	public String getJiaoxuetupian() {
		return jiaoxuetupian;
	}
